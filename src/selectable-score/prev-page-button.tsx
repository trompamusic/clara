...
const PrevPageButton: React.FC<Props> = ({
  ...
  const prevPage = () => {
    scorePrevPageStatic(uri, score.pageState[uri].currentPage, score.MEI[uri]);
  };
...
const mapDispatchToProps = (dispatch: Dispatch): PrevPageDispatchProps =>
  bindActionCreators({ scorePrevPageStatic }, dispatch);
