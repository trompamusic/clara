...
class SubmitButton extends Component {
  ...
  post() {
    let submitHandlerArgs =
      "submitHandlerArgs" in this.props ? this.props.submitHandlerArgs : {};
    this.props.postAnnotation(
      this.props.submitUri,
      "",
      this.props.submitHandler(submitHandlerArgs),
      "",
      typeof this.props.onResponse === "function"
        ? this.props.onResponse
        : this.defaultOnResponse,
    );
  }

  render() {
    const buttonContent =
      "buttonContent" in this.props ? this.props.buttonContent : "Submit";
