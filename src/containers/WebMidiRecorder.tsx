        ...
        navigator.requestMIDIAccess({ sysex: false }).then(
          (midi: any) => {
            ...
            for (
              ...
              input.value.addEventListener("midimessage", (mes: any) =>
                handleMidiMessage(mes),
              );
              i.push(input.value);
            }
          },
    ...
    <div id="authWrapper">
      {midiSupported ? (
        <div id="midi">
          ...
          {uploadError && (
            <p>
              There was an error uploading your performance. Please try again.
            </p>
          )}
          {midiPerformance && (
            <span>
